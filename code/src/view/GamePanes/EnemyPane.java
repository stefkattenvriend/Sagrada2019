...
public class EnemyPane extends BorderPane{
	...
	private void setUp() {
		...
		enemyWindow1 = new EnemyWindow(DiceHolderType.ENEMY1, gameController.getDiceHolderController(), gameController.getPatterncardController());
		enemyWindow2 = new EnemyWindow(DiceHolderType.ENEMY2, gameController.getDiceHolderController(), gameController.getPatterncardController());
		enemyWindow3 = new EnemyWindow(DiceHolderType.ENEMY3, gameController.getDiceHolderController(), gameController.getPatterncardController());
